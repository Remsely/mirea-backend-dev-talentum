...
from .models import SelfAssessment, FeedbackRequest, PeerFeedback, \
    ExpertEvaluation
...
class FeedbackRequestAdmin(admin.ModelAdmin):
    list_display = ('goal', 'reviewer', 'requested_by', 'status',
                    'created_dttm')
    list_filter = ('status', 'created_dttm')
    search_fields = ('goal__title', 'reviewer__user__first_name',
                     'reviewer__user__last_name',
                     'requested_by__user__first_name',
                     'requested_by__user__last_name', 'message')
...
class PeerFeedbackAdmin(admin.ModelAdmin):
    ...
    list_filter = ('rating', 'created_dttm')
    search_fields = ('feedback_request__goal__title',
                     'feedback_request__reviewer__user__first_name',
                     'feedback_request__reviewer__user__last_name', 'comments',
                     'areas_to_improve')
...
class ExpertEvaluationAdmin(admin.ModelAdmin):
    ...
    search_fields = ('goal__title', 'expert__user__first_name',
                     'expert__user__last_name',
                     'comments', 'areas_to_improve')
